...
public final class HopperConstants {
    ...
    // PIDController for tuning on the real robot
    public static final PIDController PID = new PIDController(0.0, 0.0, 0.0);

    // PID Constants for after tuning
    ...
    public static final Distance HOPPER_MIN_EXTENSION = Inches.of(0.0); // Starting point
    ...
    public static final Distance EXTEND_INCREMENT = Inches.of(0.3); // How much hopper will extend when agitating
    public static final Distance AGITATE_TOLERANCE = Inches.of(0.25); // Tolerance for isNear() in any hopper commands
